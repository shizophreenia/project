...
def bot_message(message):
    if message.chat.type == 'private':
        if message.text == 'Информация':
            ...
            bot.send_message(message.chat.id, 'Данный бот даст предоставляет общую информацию про различные диеты и их составление, а также помогает высчитать калорийность любого продукта!\nВыберите интересующий Вас пункт, основываясь на кнопки ниже.',reply_markup=markup)
